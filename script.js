...
function toggleMailingAddressDivs() {
        const radioButtons = document.querySelectorAll('input[name="option"]');
        const divs = document.querySelectorAll('div[id^="mailingaddressdiv"]'); // Selects divs starting with "div"
        ...
        // Optional: Call the function on page load to set initial state if a radio button is checked by default
        window.onload = toggleMailingAddressDivs;

function toggleChildMailingAddressDivs() {
        const radioButtons = document.querySelectorAll('input[name="option"]');
        const divs = document.querySelectorAll('div[id^="childmailingaddressdiv"]'); // Selects divs starting with "div"
        ...
        // Optional: Call the function on page load to set initial state if a radio button is checked by default
        window.onload = toggleChildMailingAddressDivs;